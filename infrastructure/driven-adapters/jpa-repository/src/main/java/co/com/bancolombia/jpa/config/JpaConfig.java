...
public class JpaConfig {
    ...
    public DBSecret dbSecret() {
        return DBSecret.builder().username("root")
                .password("123456")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        LocalContainerEntityManagerFactoryBean sab = new LocalContainerEntityManagerFactoryBean();
        sab.setDataSource(dataSource);
        //sab.setDataSource(datasource(dbSecret(), "com.mysql.jdbc.Driver"));
        sab.setPackagesToScan("co.com.bancolombia.jpa");

        JpaVendorAdapter vendorAdapter = new HibernateJpaVendorAdapter();
        sab.setJpaVendorAdapter(vendorAdapter);

        Properties properties = new Properties();
        properties.setProperty("hibernate.dialect", dialect);
        properties.setProperty("hibernate.hbm2ddl.auto", "update"); // TODO: remove this for non auto create schema
        sab.setJpaProperties(properties);
